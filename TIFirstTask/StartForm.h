...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"Ўифрование методом \"железнодорожной изгороди\"";
			...
			this->button2->Text = L"Ўифрование методом ¬иженера с прогрессивным ключем";
